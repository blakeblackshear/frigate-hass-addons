...
Or, in your Home Assistant, navigate to _Settings_ > _Apps_ > _Install App_ > **top right menu** _..._  > _Repositories_ and add `https://github.com/blakeblackshear/frigate-hass-addons` to the list.
